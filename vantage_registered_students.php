...
if ($_SERVER["REQUEST_METHOD"] === "POST" && isset($_FILES["csv_file"])) {
    ...
    try {
        ...
        $stmt = $conn->prepare("INSERT INTO students
            (upid, program_type, program, course, reg_no, student_name, email, phone_no, batch, year_of_passing, percentage, vantage_participant, academic_year)
            VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, 'yes', '" . $conn->real_escape_string($current_ay) . "')");
