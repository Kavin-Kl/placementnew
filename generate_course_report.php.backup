...
if ($course === 'ALL') {
    ...
    echo "<tr><td>Average CTC</td><td>$average_ctc LPA</td></tr>";
    echo "<tr><td>Median CTC</td><td>$median_ctc LPA</td></tr>";
    echo "<tr><td>Highest CTC</td><td>$highest_ctc LPA</td></tr>";
...
<?php endif; ?>
   ...
   <table class="table table-bordered table-striped">
    ...
    <table class="table table-bordered table-striped">
        ...
        <tbody>
            <tr><td>Average CTC</td><td><?= $average_ctc ?> LPA</td></tr>
            <tr><td>Median CTC</td><td><?= $median_ctc ?> LPA</td></tr>
            <tr><td>Highest CTC</td><td><?= $highest_ctc ?> LPA</td></tr>
        </tbody>
    </table>
