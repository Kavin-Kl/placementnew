...
<div class="container-fluid">
    <div class="row mb-4">
        <div class="col-12">
            <h3><i class='bx bx-list-check'></i> Manage Round-wise Results - Internships</h3>
            ...
            <?php if ($selected_drive && count($applications) > 0): ?>
                ...
                <div class="bulk-actions-bar" style="background: white; border-radius: 12px; padding: 15px; margin-bottom: 20px; box-shadow: 0 2px 8px rgba(0,0,0,0.1);">
                    <div class="d-flex justify-content-between align-items-center">
                        ...
                        <div>
                            <button type="button" class="btn btn-info btn-sm" onclick="exportRoundResults()" style="margin-right: 10px;">
                                <i class='bx bx-download'></i> Export Results to Excel
                            </button>
...
// Export round results to Excel
function exportRoundResults() {
    ...
    window.open('export_round_results.php?drive_id=' + driveId, '_blank');
}
</script>
