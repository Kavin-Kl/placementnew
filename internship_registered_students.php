...
function fetch_students($conn, $where, $types, $params, $limit = 50, $offset = 0) {
    error_log("Where clauses: " . json_encode($where));
...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['ajax_filter'])) {
    error_log("AJAX request received - ajax_filter is set");
    $types = '';
    $params = [];
        ...
        foreach ($dataRows as $data) {
            ...
            if ($stmt) {
                $stmt->bind_param("sssssssssiss",
                    ...
                    $batchYear, $yearOfPassing, $percentage, $class
                );
...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['export_all'])) {
    ...
    header('Content-Disposition: attachment;filename="internship_registered_students.xlsx"');
...
<body>
  ...
  <?php include 'header.php'; ?>
    <div class="heading-container">
      <h3 class="headings">Internship Registered Students</h3>
    ...
    <div class="top-bar">
      <div class="left-controls">
        <div class="search-filter-btn-container" style="position: relative;">
          ...
          <a href="internship_registered_students" class="reset-button">
...
document.getElementById("exportForm").addEventListener("submit", function(e) {
    ...
    xhr.open("POST", "internship_registered_students", true);
    ...
    xhr.onload = function() {
        if (this.status === 200) {
            ...
            link.download = "internship_registered_students.xlsx";
            link.click();
            closeExportModal();
        }
    };
