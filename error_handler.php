...
function _placement_render_error_page(string $headline, string $detail = ''): void {
    if (headers_sent()) {
    ...
    echo "<!doctype html><html lang='en'><head><meta charset='utf-8'>
        ...
        <style>
            ...
            a.btn{display:inline-block;margin-top:18px;padding:8px 18px;background:#650000;color:#fff;text-decoration:none;border-radius:6px}
            a.btn:hover{background:#7d0000}
        </style></head><body>
        <div class='card'>
